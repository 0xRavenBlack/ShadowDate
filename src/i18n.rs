...
pub fn t(key: &str) -> &'static str {
    ...
    let (en, de, fr, es, zh, ja, pl) = match key {
        ...
        "series_edit_warning" => (
            "This appointment is part of a series of {n} events. Saving will replace the entire series with this single appointment.",
            "Dieser Termin ist Teil einer Serie von {n} Terminen. Beim Speichern wird die gesamte Serie durch diesen einen Termin ersetzt.",
            "Ce rendez-vous fait partie d'une série de {n} événements. L'enregistrement remplacera toute la série par ce seul rendez-vous.",
            "Esta cita forma parte de una serie de {n} eventos. Al guardar, se reemplazará toda la serie por esta única cita.",
            "此约会是一个包含 {n} 个事件的系列的一部分。保存后，整个系列将替换为这一个约会。",
            "この予定は {n} 件のイベントの系列に属しています。保存すると、系列全体がこの1件の予定に置き換わります。",
            "To wydarzenie należy do serii {n} wydarzeń. Zapis zastąpi całą serię tym pojedynczym wydarzeniem.",
        ),
        "series_delete_body" => (
            "This will permanently delete all {n} events in this series. This cannot be undone.",
            "Dadurch werden alle {n} Termine dieser Serie dauerhaft gelöscht. Dies kann nicht rückgängig gemacht werden.",
            "Toute la série de {n} événements sera définitivement supprimée. Cette action est irréversible.",
            "Esto eliminará permanentemente los {n} eventos de esta serie. No se puede deshacer.",
            "这将永久删除此系列中的全部 {n} 个事件。此操作无法撤销。",
            "この系列の {n} 件すべてを完全に削除します。この操作は元に戻せません。",
            "Spowoduje to trwałe usunięcie wszystkich {n} wydarzeń z tej serii. Nie można tego cofnąć.",
        ),
        "add_appointment" => (
            "+ Add appointment",
            "+ Termin hinzufügen",
        ...
        "show_background" => (
            ...
            "Hintergrundporträt anzeigen",
            "Afficher le portrait de fond",
            "Mostrar retrato de fondo",
            "显示背景画像",
            "背景ポートレートを表示",
            "Pokaż portret w tle",
        ),
        ...
        "load_warnings_backed_up" => (
            "Some calendar entries could not be read and were skipped. A backup was saved to:",
            "Einige Kalendereinträge konnten nicht gelesen werden und wurden übersprungen. Eine Sicherungskopie wurde gespeichert unter:",
            "Certaines entrées du calendrier n'ont pas pu être lues et ont été ignorées. Une sauvegarde a été enregistrée dans :",
            "Algunas entradas del calendario no se pudieron leer y se omitieron. Se guardó una copia de seguridad en:",
            "日历中的部分条目无法读取，已跳过。备份已保存到：",
            "カレンダーの一部の項目を読み取れず、スキップしました。バックアップは次に保存されました：",
            "Niektóre wpisy kalendarza nie mogły zostać odczytane i zostały pominięte. Kopia zapasowa została zapisana w:",
        ),
        "import_warnings" => (
